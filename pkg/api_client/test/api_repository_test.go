...
func Test_api_client_RepositoryAPIService(t *testing.T) {
	...
	t.Run("Test RepositoryAPIService PostRepositoriesRepositorySyncerClaim", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var primaryKey string

		resp, httpRes, err := apiClient.RepositoryAPI.PostRepositoriesRepositorySyncerClaim(context.Background(), primaryKey).Execute()
