...
func Test_api_client_RepositoryAPIService(t *testing.T) {
	...
	t.Run("Test RepositoryAPIService PostRepositoriesChangeProducerClaim", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		var primaryKey string

		resp, httpRes, err := apiClient.RepositoryAPI.PostRepositoriesChangeProducerClaim(context.Background(), primaryKey).Execute()
