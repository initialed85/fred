...
func Test_api_client_ExecutionAPIService(t *testing.T) {
	...
	t.Run("Test ExecutionAPIService PostExecutionsJobExecutorClaim", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var primaryKey string

		resp, httpRes, err := apiClient.ExecutionAPI.PostExecutionsJobExecutorClaim(context.Background(), primaryKey).Execute()
