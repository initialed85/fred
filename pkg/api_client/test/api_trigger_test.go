...
func Test_api_client_TriggerAPIService(t *testing.T) {
	...
	t.Run("Test TriggerAPIService PostTriggersJobExecutorClaim", func(t *testing.T) {

		t.Skip("skip test") // remove to run test

		var primaryKey string

		resp, httpRes, err := apiClient.TriggerAPI.PostTriggersJobExecutorClaim(context.Background(), primaryKey).Execute()
